...
// neighborEntry.
func newNeighborEntry(clock tcpip.Clock, nic *NIC, remoteAddr tcpip.Address, localAddr tcpip.Address, nudState *NUDState, linkRes LinkAddressResolver) *neighborEntry {
	e := &neighborEntry{
		clock:    clock,
		nic:      nic,
		linkRes:  linkRes,
...
// `setStateLocked`.
func newStaticNeighborEntry(clock tcpip.Clock, nic *NIC, addr tcpip.Address, linkAddr tcpip.LinkAddress, state *NUDState) *neighborEntry {
