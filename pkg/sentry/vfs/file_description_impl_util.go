...
func (fd *DynamicBytesFileDescriptionImpl) Offset() uint64 {
...
// LockPOSIX implements lock.PosixLocker.
func (fd *LockFD) LockRange(uid fslock.UniqueID, t fslock.LockType, rng fslock.LockRange, block fslock.Blocker) error {
	return fd.locks.LockPOSIX(uid, t, rng, block)
}

// UnlockPOSIX implements lock.PosixLocker.
func (fd *LockFD) UnlockRange(uid fslock.UniqueID, rng fslock.LockRange) error {
