...
func (conn *TCPIPv4) Handshake() {
	conn.HandshakeWithOptions(nil)
}

// HandshakeWithOptions performs a TCP 3-way handshake with the specified
// options. The input Connection should have a final TCP Layer.
func (conn *TCPIPv4) HandshakeWithOptions(options []byte) {
	// Send the SYN.
